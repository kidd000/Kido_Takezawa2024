...
def run():
    ...
    def main():
        ...
        for generation in range(MAX_GEN):
            # 2D numpy arrays for X strategy, Y strategy, payoff, fitness
            str_X_arr = np.random.randint(0, high=2, size=(GROUP_NUM, GROUP_SIZE))  # X strategies of all agents
            str_Y_arr = np.random.randint(0, high=2, size=(GROUP_NUM, GROUP_SIZE))  # Y strategies of all agents
